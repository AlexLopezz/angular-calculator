...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.login = function (user) {
        return this.http.post('/login', user)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function () { throw Error('Credentials error.'); }));
    };
    AuthService.prototype.signup = function (user) {
        return this.http.post('/signup', user)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function () { throw Error('A user with the same credentials already exists.'); }));
    };
    AuthService.prototype.logout = function (dataRequest) {
